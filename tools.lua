local common_table = {
	...
	Athenium = {level=3,  range=4.0, interval=0.90, uses=45,  maxlevel=2, handle='group:stick'},
	Koblint    = {level=4,  range=4.0, interval=0.89, uses=55,  maxlevel=2, handle='group:stick'},
	Ormium =   {level=5,  range=4.1, interval=1.00, uses=70,  maxlevel=3, handle='xtraores_redo:steel_handle'},
	Varytrium =    {level=6,  range=4.1, interval=0.88, uses=80,  maxlevel=3, handle='xtraores_redo:steel_handle',},
	Flumium =   {level=7,  range=4.1, interval=0.87, uses=120, maxlevel=3, handle='xtraores_redo:steel_handle',},
	Syrium =  {level=8,  range=4.1, interval=0.86, uses=145, maxlevel=3, handle='xtraores_redo:steel_handle',},
	Zeltium =    {level=9,  range=4.2, interval=0.85, uses=175, maxlevel=3, handle='xtraores_redo:duraglass_handle',},
	Orichalcum ={level=10, range=4.2, interval=0.84, uses=220, maxlevel=3, handle='xtraores_redo:duraglass_handle',},
	Tartarsium =  {level=11, range=4.2, interval=0.83, uses=250, maxlevel=3, handle='xtraores_redo:duraglass_handle',},
	Tsevium =  {level=12, range=4.2, interval=0.80, uses=320, maxlevel=3, handle='xtraores_redo:duraglass_handle',},
}

local picks_table = {
	Nickel =    {damage=3,  crackytimes={6.00, 1.90, 0.90}},
	Platinum =  {damage=4,  crackytimes={4.50, 1.70, 0.75}},
	Athenium = {damage=5,  crackytimes={1.90, 1.10, 0.70, 4.00}},
	Koblint =    {damage=6,  crackytimes={1.80, 1.00, 0.50, 3.50, 6.00}},
	Ormium =   {damage=9, crackytimes={1.50, 0.85, 0.40, 3.40, 5.40, 8.00},
							 crumblytimes={1.20, 0.60, 0.30}},
	Varytrium =    {damage=10, crackytimes={1.40, 0.75, 0.35, 3.10, 5.20, 7.20, 10.0},
							 crumblytimes={1.10, 0.50, 0.25}},
	Flumium =   {damage=11, crackytimes={1.20, 0.65, 0.30, 2.60, 4.80, 6.40, 9.0, 12.0},
							 crumblytimes={1.00, 0.45, 0.21}},
	Syrium =  {damage=12, crackytimes={1.10, 0.60, 0.25, 2.20, 4.40, 6.00, 8.0, 10.0, 15.0},
							 crumblytimes={0.90, 0.40, 0.18}},
	Zeltium =    {damage=14, crackytimes={0.90, 0.45, 0.20, 1.80, 3.70, 5.00, 7.2, 8.0, 12.0, 20.0},
	...
	Tartarsium =  {damage=16, crackytimes={0.75, 0.32, 0.12, 1.00, 2.80, 3.80, 5.8, 6.0, 8.2, 13.5, 20.0, 30.0},
							 crumblytimes={0.65, 0.25, 0.09}},
	Tsevium =  {damage=17, crackytimes={0.70, 0.29, 0.10, 0.80, 2.40, 3.20, 4.8, 5.0, 7.2, 10.0, 15.0, 22.0, 36.0},
...
local shovels_table = {
	...
	Athenium = {damage=4, crumblytimes={1.00, 0.60, 0.35}},
	Koblint =    {damage=5, crumblytimes={0.95, 0.50, 0.25}},
}
...
local axes_table = {
	...
	Athenium = {damage=6,  choppytimes={2.00, 1.00, 0.75}},
	Koblint =    {damage=8,  choppytimes={1.90, 0.90, 0.50}},
	Ormium =   {damage=10, choppytimes={2.00, 1.00, 0.60}},
	Varytrium =    {damage=11, choppytimes={1.80, 0.80, 0.40}},
	Flumium =   {damage=13, choppytimes={1.70, 0.75, 0.35}},
	Syrium =  {damage=14, choppytimes={1.65, 0.60, 0.30}},
	Zeltium =    {damage=16, choppytimes={1.50, 0.55, 0.25}},
	Orichalcum ={damage=18, choppytimes={1.40, 0.45, 0.21}},
	Tartarsium =  {damage=20, choppytimes={1.30, 0.40, 0.18}},
	Tsevium =  {damage=22, choppytimes={1.20, 0.35, 0.15}},
}
...
local swords_table = {
	...
	Athenium = {damage=7,  snappytimes={1.80, 1.00, 0.35}},
	Koblint =    {damage=8,  snappytimes={1.80, 0.90, 0.30}},
	Ormium =   {damage=10, snappytimes={1.70, 0.80, 0.25}, has_spear=true},
	Varytrium =    {damage=12, snappytimes={1.60, 0.70, 0.20}, has_spear=true},
	Flumium =   {damage=14, snappytimes={1.50, 0.65, 0.10}, has_spear=true},
	Syrium =  {damage=16, snappytimes={1.40, 0.60, 0.15}, has_spear=true},
	Zeltium =    {damage=19, snappytimes={1.30, 0.55, 0.12}, has_spear=true},
	Orichalcum ={damage=21, snappytimes={1.20, 0.48, 0.10}, has_spear=true},
	Tartarsium =  {damage=23, snappytimes={1.10, 0.40, 0.08}, has_spear=true},
	Tsevium =  {damage=26, snappytimes={1.00, 0.35, 0.06}, has_spear=true},
}
